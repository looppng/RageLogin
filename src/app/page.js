      ...
      <div className="absolute -ms-64 me-72 z-30">
        ...
        <form>
          ...
          <div className="flex justify-center gap-3">
            <button
              type="submit"
              className="text-white flex align-center bg-[#6A7963] hover:bg-blue-800 font-normal text-lg px-10 py-2.5 text-center"
            >
              Pievienoties
            </button>
            <button
              type="submit"
              className="text-white bg-[#796363] hover:bg-blue-800 font-normal text-sm px-5 py-2.5 text-center"
            >
              +
            </button>
          </div>
